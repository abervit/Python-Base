...
def rtn_player(): # tell us which player will have a turn
    player = turn % players
    return player if player > 0 else players


def get_answer(): # checking if players chose the right amount of matches
    val = 0
    try:
...
while matches > 0: # shows us how many matches we have left
